...
const Toy = () => {
  ...
  const handleDecreaseQty = (idx) => {
    ...
    if (updatedOrder[idx].quantity > 1) {
      updatedOrder[idx].quantity -= 1;
      setOrder(updatedOrder);
    } else {
      // Optional: remove the item if quantity is 1
      handleDeleteOrder(idx);
    }
  };
        ...
        >
          {isOrderView ? (
            ...
            <div>
              ...
              <p>
                <strong> $ {selectproduct?.title}</strong>
              </p>
              <p>
